...
export default function LiveDemo() {
  ...
  return (
    <section className="bg-white py-8 md:py-12 px-4 sm:px-6 border-t border-gray-50">
      <div className="max-w-7xl mx-auto text-center">
        ...
        {/* Subheading */}
        <p className="text-[16px] md:text-[18px] text-[#324578] mb-8 md:mb-12 font-sans font-medium opacity-90 leading-[1.5] md:leading-normal">
