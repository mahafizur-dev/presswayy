...
export async function POST(req: Request) {
  try {
    ...
    if (verifyData.status === "VALID" || verifyData.status === "VALIDATED") {
      try {
        // 💡 সাবস্ক্রিপশন পেলোড: n8n-এ সাবস্ক্রিপশন অ্যাক্টিভেট/এক্সটেন্ড করার জন্য
        const ipnPayload = {
          client_id: verifyData.value_a,
          plan: verifyData.value_b || "monthly",
        ...
        // পৃথক n8n এন্ডপয়েন্ট (রিচার্জ থেকে আলাদা)
        const webhookUrl = `${apiUrl}/sslcommerz-subscription-ipn`;
